...
var promoTypeLabels = map[string]string{
	...
	"editionbeta":            "Edition Beta",
	"eventpack":              "Event Pack",
	"eventpromo":             "Event Promo",
	"firstcombat":            "First Combat",
	"freedomascension":       "Freedom Ascension",
	"gamaexpo":               "GAMA Expo",
	"gencon":                 "Gen Con",
	"ggenerationeternal":     "G Generation Eternal",
	"gnfullshield":           "GN Full Shield",
	"gnhighmegalauncher":     "GN High Mega Launcher",
	...
	"lefthand":               "Left Hand",
	"linkrare":               "Link Rare",
	"mirasoulflightunit":     "Mirasoul Flight Unit",
