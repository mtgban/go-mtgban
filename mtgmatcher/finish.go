...
// these itself (Magic's etched foil, Lorcana's rainbow pillars, the reverse
// holos and first editions the pending games bring) through
// GameRules.CanonicalFinish, and the names it hands back are the keys of
// Card.FoilUUIDs and the value of CardObject.Finish, so one spelling reaches
// a printing from every source.
const (
