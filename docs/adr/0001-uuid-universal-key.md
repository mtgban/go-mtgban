...
> sniffs a format any more. bantool takes the game as its own `-game` flag,
> stated separately from which scraper it runs. The text below describes
> the loaders as they were.
