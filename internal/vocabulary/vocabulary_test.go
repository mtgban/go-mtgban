...
// carrying none says so rather than passing on nothing. The effective label
// includes the loader's fallback for newly published tokens, while genuine
// vocabulary defects remain fatal and catalog wording drift is diagnostic.
